...
from apdoc a, aptran b, apadjust c
     
where (a.refnbr = b.refnbr and (a.refnbr = c.adjdrefnbr)
AND (a.DocType = 'VO' OR a.DocType = 'AD') 
AND b.acct not in (2000, 2001, 2002) 
AND c.S4Future11 <> 'V'
and a.origdocamt = c.adjamt
AND c.perappl = 201111)