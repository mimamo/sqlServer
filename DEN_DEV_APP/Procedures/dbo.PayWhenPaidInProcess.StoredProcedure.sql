...
CREATE PROCEDURE [dbo].[PayWhenPaidInProcess]     
 ...
 AS
/*******************************************************************************************************
*   DEN_DEV_APP.dbo.PayWhenPaidInProcess 
*
...
*
*   Usage:
		execute DEN_DEV_APP.dbo.PayWhenPaidInProcess @Company = 'DALLAS'
        execute DEN_DEV_APP.dbo.PayWhenPaidInProcess @Company = 'MIDWEST'
        execute DEN_DEV_APP.dbo.PayWhenPaidInProcess @Company = 'NY'
        execute DEN_DEV_APP.dbo.PayWhenPaidInProcess @Company = 'SHOPPER'
...
/*
execute DEN_DEV_APP.dbo.PayWhenPaidInProcess 
