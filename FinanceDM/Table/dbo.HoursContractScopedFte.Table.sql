...
*   Date:		04/15/20156
*		
		alter table dbo.HoursContractScopedFte drop column productCode
*
...
(
	...
	constraint [pkc_HoursContractScopedFte] primary key clustered (integerId, departmentId, ftePercent)
) ON [PRIMARY]
